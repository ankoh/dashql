    ...
    public render() {
        ...
        return (
            <div className={s.rectangle_wave}>
                <div
                    className={cN(s.rectangle_wave_rect_1, {
                        [s.active]: this.props.active,
                    })}
                    style={rectStyle}
                />
                <div
                    className={cN(s.rectangle_wave_rect_2, {
                        [s.active]: this.props.active,
                    })}
                    style={rectStyle}
                />
                <div
                    className={cN(s.rectangle_wave_rect_3, {
                        [s.active]: this.props.active,
                    })}
                    style={rectStyle}
                />
                <div
                    className={cN(s.rectangle_wave_rect_4, {
                        [s.active]: this.props.active,
                    })}
                    style={rectStyle}
                />
                <div
                    className={cN(s.rectangle_wave_rect_5, {
                        [s.active]: this.props.active,
                    })}
                    style={rectStyle}
                />
