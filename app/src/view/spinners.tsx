    ...
    public render() {
        ...
        return (
            <div className={styles.rectangle_wave}>
                <div
                    className={cN(styles.rectangle_wave_rect_1, {
                        [styles.active]: this.props.active,
                    })}
                    style={rectStyle}
                />
                <div
                    className={cN(styles.rectangle_wave_rect_2, {
                        [styles.active]: this.props.active,
                    })}
                    style={rectStyle}
                />
                <div
                    className={cN(styles.rectangle_wave_rect_3, {
                        [styles.active]: this.props.active,
                    })}
                    style={rectStyle}
                />
                <div
                    className={cN(styles.rectangle_wave_rect_4, {
                        [styles.active]: this.props.active,
                    })}
                    style={rectStyle}
                />
                <div
                    className={cN(styles.rectangle_wave_rect_5, {
                        [styles.active]: this.props.active,
                    })}
                    style={rectStyle}
                />
