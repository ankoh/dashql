...
export const useWasmDatabaseLogger = (): duckdb.Logger => React.useContext(loggerCtx)!;
export const useWasmDatabaseBundle = (): Resolvable<duckdb.DuckDBBundle> => React.useContext(bundleCtx)!;
export const useWasmDatabaseBundleResolver = (): Resolver<duckdb.DuckDBBundle> => React.useContext(resolverCtx)!;

export const WasmDatabasePlatform: React.FC<PlatformProps> = (props: PlatformProps) => {
