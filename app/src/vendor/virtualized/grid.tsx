...
import calculateSizeAndPositionDataAndUpdateScrollOffset from './utils/calculate_size_and_position_data_and_update_scroll_offset';
import ScalingCellSizeAndPositionManager from './utils/scaling_cellsize_and_position_manager';
import createCallbackMemoizer from './utils/create_callback_memoizer';
import defaultOverscanIndicesGetter, {
    SCROLL_DIRECTION_BACKWARD,
    SCROLL_DIRECTION_FORWARD,
} from './utils/default_overscan_indices_getter';
import updateScrollIndexHelper from './utils/update_scroll_index_helper';
import defaultCellRangeRenderer from './utils/default_cell_range_renderer';
 ...
 */
const enum SCROLL_POSITION_CHANGE_REASONS {
    OBSERVED = 'observed',
    REQUESTED = 'requested',
}
...
type Props = {
     ...
     */
    onScroll?: (params: GridScroll) => void;
...
export class Grid extends React.PureComponent<Props, State> {
    ...
    _recomputeScrollLeftFlag: boolean = false;
    _recomputeScrollTopFlag: boolean = false;

    _horizontalScrollBarSize: number = 0;
    _verticalScrollBarSize: number = 0;
    _scrollbarPresenceChanged: boolean = false;
    _scrollingContainer: Element;

    _childrenToDisplay: React.ReactElement[];
    ...
    static getDerivedStateFromProps(nextProps: Props, prevState: State): State {
        ...
        let maybeStateA: State | undefined = undefined;
        let maybeStateB: State | undefined = undefined;
    ...
    _onScroll = (event: React.UIEvent<HTMLDivElement, UIEvent>) => {
