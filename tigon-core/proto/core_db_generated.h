...
#ifndef FLATBUFFERS_GENERATED_COREDB_TIGONCORE_DB_H_
#define FLATBUFFERS_GENERATED_COREDB_TIGONCORE_DB_H_
...
inline flatbuffers::Offset<Error> CreateErrorDirect(
  ...
  return TigonCore::DB::CreateError(
      _fbb,
      code,
...
inline flatbuffers::Offset<QueryPlan> CreateQueryPlanDirect(
  ...
  return TigonCore::DB::CreateQueryPlan(
      _fbb,
      node_names ? _fbb.CreateVector<flatbuffers::Offset<flatbuffers::String>>(*node_names) : 0,
      node_child_offsets ? _fbb.CreateVector<uint64_t>(*node_child_offsets) : 0,
      node_children ? _fbb.CreateVector<uint64_t>(*node_children) : 0,
      node_timings ? _fbb.CreateVector<double>(*node_timings) : 0,
      node_cardinalities ? _fbb.CreateVector<uint64_t>(*node_cardinalities) : 0);
}
...
inline flatbuffers::Offset<QueryResult> CreateQueryResultDirect(
  ...
  return TigonCore::DB::CreateQueryResult(
      _fbb,
      query_id,
      query_plan,
      row_count,
      column_types_sql ? _fbb.CreateVector<uint8_t>(*column_types_sql) : 0,
      column_types_raw ? _fbb.CreateVector<uint8_t>(*column_types_raw) : 0,
...
#endif  // FLATBUFFERS_GENERATED_COREDB_TIGONCORE_DB_H_
