...
import * as NS1082650742416883453 from "./query_plan_generated";
import * as NS1899063153574777154 from "./value_generated";
/**
 * @constructor
 */
 ...
 */
physicalType():NS1899063153574777154.PhysicalTypeID {
  var offset = this.bb!.__offset(this.bb_pos, 4);
  return offset ? /**  */ (this.bb!.readUint8(this.bb_pos + offset)) : NS1899063153574777154.PhysicalTypeID.NA;
};
 ...
 */
static addPhysicalType(builder:flatbuffers.Builder, physicalType:NS1899063153574777154.PhysicalTypeID) {
  builder.addFieldInt8(0, physicalType, NS1899063153574777154.PhysicalTypeID.NA);
};
 ...
 */
queryPlan(obj?:NS1082650742416883453.QueryPlan):NS1082650742416883453.QueryPlan|null {
  var offset = this.bb!.__offset(this.bb_pos, 6);
  return offset ? (obj || new NS1082650742416883453.QueryPlan()).__init(this.bb!.__indirect(this.bb_pos + offset), this.bb!) : null;
};
 ...
 * @returns LogicalType
 */
columnTypes(index: number, obj?:NS1899063153574777154.LogicalType):NS1899063153574777154.LogicalType|null {
  var offset = this.bb!.__offset(this.bb_pos, 8);
  return offset ? (obj || new NS1899063153574777154.LogicalType()).__init(this.bb!.__vector(this.bb_pos + offset) + index * 6, this.bb!) : null;
};
