...
import * as NS5415769519774419770 from "./query_plan_generated";
import * as NS11941347343030666943 from "./value_generated";
/**
 * @constructor
 */
 ...
 */
physicalType():NS11941347343030666943.PhysicalTypeID {
  var offset = this.bb!.__offset(this.bb_pos, 4);
  return offset ? /**  */ (this.bb!.readUint8(this.bb_pos + offset)) : NS11941347343030666943.PhysicalTypeID.NA;
};
 ...
 */
static addPhysicalType(builder:flatbuffers.Builder, physicalType:NS11941347343030666943.PhysicalTypeID) {
  builder.addFieldInt8(0, physicalType, NS11941347343030666943.PhysicalTypeID.NA);
};
...
static createQueryResultColumn(builder:flatbuffers.Builder, physicalType:NS11941347343030666943.PhysicalTypeID, nullMaskOffset:flatbuffers.Offset, rowsU8Offset:flatbuffers.Offset, rowsI16Offset:flatbuffers.Offset, rowsU16Offset:flatbuffers.Offset, rowsI32Offset:flatbuffers.Offset, rowsI64Offset:flatbuffers.Offset, rowsU64Offset:flatbuffers.Offset, rowsF32Offset:flatbuffers.Offset, rowsF64Offset:flatbuffers.Offset, rowsStringOffset:flatbuffers.Offset):flatbuffers.Offset {
 ...
 */
queryPlan(obj?:NS5415769519774419770.QueryPlan):NS5415769519774419770.QueryPlan|null {
  var offset = this.bb!.__offset(this.bb_pos, 6);
  return offset ? (obj || new NS5415769519774419770.QueryPlan()).__init(this.bb!.__indirect(this.bb_pos + offset), this.bb!) : null;
};
 ...
 * @returns LogicalType
 */
columnTypes(index: number, obj?:NS11941347343030666943.LogicalType):NS11941347343030666943.LogicalType|null {
  var offset = this.bb!.__offset(this.bb_pos, 8);
  return offset ? (obj || new NS11941347343030666943.LogicalType()).__init(this.bb!.__vector(this.bb_pos + offset) + index * 6, this.bb!) : null;
};
