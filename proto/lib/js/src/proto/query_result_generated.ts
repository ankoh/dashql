...
import * as NS9678098429221881324 from "./query_plan_generated";
import * as NS5993053097993249885 from "./value_generated";
/**
 * @constructor
 */
 ...
 */
physicalType():NS5993053097993249885.PhysicalTypeID {
  var offset = this.bb!.__offset(this.bb_pos, 4);
  return offset ? /**  */ (this.bb!.readUint8(this.bb_pos + offset)) : NS5993053097993249885.PhysicalTypeID.NA;
};
 ...
 */
static addPhysicalType(builder:flatbuffers.Builder, physicalType:NS5993053097993249885.PhysicalTypeID) {
  builder.addFieldInt8(0, physicalType, NS5993053097993249885.PhysicalTypeID.NA);
};
 ...
 */
queryPlan(obj?:NS9678098429221881324.QueryPlan):NS9678098429221881324.QueryPlan|null {
  var offset = this.bb!.__offset(this.bb_pos, 6);
  return offset ? (obj || new NS9678098429221881324.QueryPlan()).__init(this.bb!.__indirect(this.bb_pos + offset), this.bb!) : null;
};
 ...
 * @returns LogicalType
 */
columnTypes(index: number, obj?:NS5993053097993249885.LogicalType):NS5993053097993249885.LogicalType|null {
  var offset = this.bb!.__offset(this.bb_pos, 8);
  return offset ? (obj || new NS5993053097993249885.LogicalType()).__init(this.bb!.__vector(this.bb_pos + offset) + index * 6, this.bb!) : null;
};
