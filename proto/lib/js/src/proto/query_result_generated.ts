...
import * as NS4880897254681170641 from "./query_plan_generated";
import * as NS15866251845349550182 from "./value_generated";
/**
 * @constructor
 */
 ...
 */
physicalType():NS15866251845349550182.PhysicalTypeID {
  var offset = this.bb!.__offset(this.bb_pos, 4);
  return offset ? /**  */ (this.bb!.readUint8(this.bb_pos + offset)) : NS15866251845349550182.PhysicalTypeID.NA;
};
 ...
 */
static addPhysicalType(builder:flatbuffers.Builder, physicalType:NS15866251845349550182.PhysicalTypeID) {
  builder.addFieldInt8(0, physicalType, NS15866251845349550182.PhysicalTypeID.NA);
};
...
static createQueryResultColumn(builder:flatbuffers.Builder, physicalType:NS15866251845349550182.PhysicalTypeID, nullMaskOffset:flatbuffers.Offset, rowsU8Offset:flatbuffers.Offset, rowsI16Offset:flatbuffers.Offset, rowsU16Offset:flatbuffers.Offset, rowsI32Offset:flatbuffers.Offset, rowsI64Offset:flatbuffers.Offset, rowsU64Offset:flatbuffers.Offset, rowsF32Offset:flatbuffers.Offset, rowsF64Offset:flatbuffers.Offset, rowsStringOffset:flatbuffers.Offset):flatbuffers.Offset {
 ...
 */
queryPlan(obj?:NS4880897254681170641.QueryPlan):NS4880897254681170641.QueryPlan|null {
  var offset = this.bb!.__offset(this.bb_pos, 6);
  return offset ? (obj || new NS4880897254681170641.QueryPlan()).__init(this.bb!.__indirect(this.bb_pos + offset), this.bb!) : null;
};
 ...
 * @returns LogicalType
 */
columnTypes(index: number, obj?:NS15866251845349550182.LogicalType):NS15866251845349550182.LogicalType|null {
  var offset = this.bb!.__offset(this.bb_pos, 8);
  return offset ? (obj || new NS15866251845349550182.LogicalType()).__init(this.bb!.__vector(this.bb_pos + offset) + index * 6, this.bb!) : null;
};
 ...
 * @param flatbuffers.Builder builder
 */
static startQueryResultHeader(builder:flatbuffers.Builder) {
