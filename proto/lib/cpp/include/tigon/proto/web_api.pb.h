...
namespace tigon {
    namespace proto {
        namespace web_api {
            ...
            template<typename T> inline const std::string& StatusCode_Name(T enum_t_value) {
                static_assert(::std::is_same<T, StatusCode>::value || ::std::is_integral<T>::value, "Incorrect type passed to function StatusCode_Name.");
                return StatusCode_Name(static_cast<StatusCode>(enum_t_value));
            }
            bool StatusCode_Parse(const std::string& name, StatusCode* value);
            // ===================================================================

            class FormattedText : public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:tigon.proto.web_api.FormattedText) */ {
              public:
                FormattedText();
                virtual ~FormattedText();

                FormattedText(const FormattedText& from);
                FormattedText(FormattedText&& from) noexcept: FormattedText() {
                    *this = ::std::move(from);
                }
                ...
                static inline const FormattedText* internal_default_instance() {
                    return reinterpret_cast<const FormattedText*>(&_FormattedText_default_instance_);
                }
            ...
            class RawData : public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:tigon.proto.web_api.RawData) */ {
              public:
                RawData();
                virtual ~RawData();

                RawData(const RawData& from);
                RawData(RawData&& from) noexcept: RawData() {
                    *this = ::std::move(from);
                }
                ...
                static inline const RawData* internal_default_instance() {
                    return reinterpret_cast<const RawData*>(&_RawData_default_instance_);
                }
...
#pragma GCC diagnostic ignored "-Wstrict-aliasing"
       ...
       // FormattedText
            ...
            inline void FormattedText::set_text(std::string&& value) {
                ...
                text_.SetLite(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
            ...
            inline void FormattedText::set_text(const char* value) {
                ...
                text_.SetLite(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value), GetArenaNoVirtual());
            ...
            inline void FormattedText::set_text(const char* value, size_t size) {
                ...
                text_.SetLite(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
            ...
            inline void FormattedText::set_allocated_text(std::string* text) {
                ...
                text_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), text, GetArenaNoVirtual());
            ...
            inline std::string* FormattedText::unsafe_arena_release_text() {
                ...
                return text_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
            }
            inline void FormattedText::unsafe_arena_set_allocated_text(std::string* text) {
                GOOGLE_DCHECK(GetArenaNoVirtual() != nullptr);
                if (text != nullptr) {

                } else {
                }
                text_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), text, GetArenaNoVirtual());
            ...
            inline void RawData::set_data(std::string&& value) {
                ...
                data_.SetLite(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
                // @@protoc_insertion_point(field_set_rvalue:tigon.proto.web_api.RawData.data)
            }
            inline void RawData::set_data(const char* value) {
                GOOGLE_DCHECK(value != nullptr);

                data_.SetLite(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value), GetArenaNoVirtual());
            ...
            inline void RawData::set_data(const void* value, size_t size) {
                ...
                data_.SetLite(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
            ...
            inline void RawData::set_allocated_data(std::string* data) {
                ...
                data_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), data, GetArenaNoVirtual());
            ...
            inline std::string* RawData::unsafe_arena_release_data() {
                ...
                return data_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
            }
            inline void RawData::unsafe_arena_set_allocated_data(std::string* data) {
                GOOGLE_DCHECK(GetArenaNoVirtual() != nullptr);
                if (data != nullptr) {

                } else {
                }
                data_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), data, GetArenaNoVirtual());
