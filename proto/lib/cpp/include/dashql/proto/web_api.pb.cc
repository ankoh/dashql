...
static void InitDefaultsscc_info_FormattedText_web_5fapi_2eproto() {
  ...
  {
    void* ptr = &::dashql::proto::web_api::_FormattedText_default_instance_;
    new (ptr) ::dashql::proto::web_api::FormattedText();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::dashql::proto::web_api::FormattedText::InitAsDefaultInstance();
}
...
static void InitDefaultsscc_info_RawData_web_5fapi_2eproto() {
  ...
  {
    void* ptr = &::dashql::proto::web_api::_RawData_default_instance_;
    new (ptr) ::dashql::proto::web_api::RawData();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::dashql::proto::web_api::RawData::InitAsDefaultInstance();
}
...
FormattedText::FormattedText()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:dashql.proto.web_api.FormattedText)
}
FormattedText::FormattedText(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:dashql.proto.web_api.FormattedText)
}
FormattedText::FormattedText(const FormattedText& from)
  ...
  // @@protoc_insertion_point(copy_constructor:dashql.proto.web_api.FormattedText)
}
...
FormattedText::~FormattedText() {
  // @@protoc_insertion_point(destructor:dashql.proto.web_api.FormattedText)
  SharedDtor();
}
...
// @@protoc_insertion_point(message_clear_start:dashql.proto.web_api.FormattedText)
...
::PROTOBUF_NAMESPACE_ID::uint8* FormattedText::InternalSerializeWithCachedSizesToArray(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:dashql.proto.web_api.FormattedText)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (this->text().size() > 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      "dashql.proto.web_api.FormattedText.text");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:dashql.proto.web_api.FormattedText)
  return target;
}

size_t FormattedText::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:dashql.proto.web_api.FormattedText)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:dashql.proto.web_api.FormattedText)
...
// @@protoc_insertion_point(class_specific_copy_from_start:dashql.proto.web_api.FormattedText)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
RawData::RawData()
  : ::PROTOBUF_NAMESPACE_ID::MessageLite(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:dashql.proto.web_api.RawData)
}
RawData::RawData(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:dashql.proto.web_api.RawData)
}
RawData::RawData(const RawData& from)
  ...
  // @@protoc_insertion_point(copy_constructor:dashql.proto.web_api.RawData)
}
...
RawData::~RawData() {
  // @@protoc_insertion_point(destructor:dashql.proto.web_api.RawData)
  SharedDtor();
}
...
void RawData::Clear() {
// @@protoc_insertion_point(message_clear_start:dashql.proto.web_api.RawData)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
::PROTOBUF_NAMESPACE_ID::uint8* RawData::InternalSerializeWithCachedSizesToArray(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:dashql.proto.web_api.RawData)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:dashql.proto.web_api.RawData)
  return target;
}

size_t RawData::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:dashql.proto.web_api.RawData)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:dashql.proto.web_api.RawData)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:dashql.proto.web_api.RawData)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::dashql::proto::web_api::FormattedText* Arena::CreateMaybeMessage< ::dashql::proto::web_api::FormattedText >(Arena* arena) {
  return Arena::CreateMessageInternal< ::dashql::proto::web_api::FormattedText >(arena);
}
template<> PROTOBUF_NOINLINE ::dashql::proto::web_api::RawData* Arena::CreateMaybeMessage< ::dashql::proto::web_api::RawData >(Arena* arena) {
  return Arena::CreateMessageInternal< ::dashql::proto::web_api::RawData >(arena);
}
