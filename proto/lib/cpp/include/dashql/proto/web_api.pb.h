...
PROTOBUF_NAMESPACE_OPEN
template<> ::dashql::proto::web_api::FormattedText* Arena::CreateMaybeMessage<::dashql::proto::web_api::FormattedText>(Arena*);
template<> ::dashql::proto::web_api::RawData* Arena::CreateMaybeMessage<::dashql::proto::web_api::RawData>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace dashql {
namespace proto {
namespace web_api {
...
class FormattedText :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:dashql.proto.web_api.FormattedText) */ {
 public:
  FormattedText();
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "dashql.proto.web_api.FormattedText";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:dashql.proto.web_api.FormattedText)
 private:
  class _Internal;
...
class RawData :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:dashql.proto.web_api.RawData) */ {
 public:
  RawData();
  virtual ~RawData();
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "dashql.proto.web_api.RawData";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:dashql.proto.web_api.RawData)
 private:
  class _Internal;
...
inline const std::string& FormattedText::text() const {
  // @@protoc_insertion_point(field_get:dashql.proto.web_api.FormattedText.text)
  return _internal_text();
}
inline void FormattedText::set_text(const std::string& value) {
  _internal_set_text(value);
  // @@protoc_insertion_point(field_set:dashql.proto.web_api.FormattedText.text)
}
inline std::string* FormattedText::mutable_text() {
  // @@protoc_insertion_point(field_mutable:dashql.proto.web_api.FormattedText.text)
...
inline void FormattedText::set_text(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:dashql.proto.web_api.FormattedText.text)
}
inline void FormattedText::set_text(const char* value) {
  ...
  text_.SetLite(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:dashql.proto.web_api.FormattedText.text)
}
inline void FormattedText::set_text(const char* value,
    size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:dashql.proto.web_api.FormattedText.text)
}
...
inline std::string* FormattedText::release_text() {
  // @@protoc_insertion_point(field_release:dashql.proto.web_api.FormattedText.text)
...
inline void FormattedText::set_allocated_text(std::string* text) {
  ...
  text_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), text,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:dashql.proto.web_api.FormattedText.text)
}
inline std::string* FormattedText::unsafe_arena_release_text() {
  // @@protoc_insertion_point(field_unsafe_arena_release:dashql.proto.web_api.FormattedText.text)
...
inline void FormattedText::unsafe_arena_set_allocated_text(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:dashql.proto.web_api.FormattedText.text)
}
...
inline const std::string& RawData::data() const {
  // @@protoc_insertion_point(field_get:dashql.proto.web_api.RawData.data)
  return _internal_data();
}
inline void RawData::set_data(const std::string& value) {
  _internal_set_data(value);
  // @@protoc_insertion_point(field_set:dashql.proto.web_api.RawData.data)
}
inline std::string* RawData::mutable_data() {
  // @@protoc_insertion_point(field_mutable:dashql.proto.web_api.RawData.data)
...
inline void RawData::set_data(std::string&& value) {
  ...
  data_.SetLite(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_rvalue:dashql.proto.web_api.RawData.data)
}
inline void RawData::set_data(const char* value) {
  ...
  data_.SetLite(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_char:dashql.proto.web_api.RawData.data)
}
inline void RawData::set_data(const void* value,
  ...
  data_.SetLite(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_pointer:dashql.proto.web_api.RawData.data)
}
...
inline std::string* RawData::release_data() {
  // @@protoc_insertion_point(field_release:dashql.proto.web_api.RawData.data)
...
inline void RawData::set_allocated_data(std::string* data) {
  ...
  data_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), data,
      GetArenaNoVirtual());
  // @@protoc_insertion_point(field_set_allocated:dashql.proto.web_api.RawData.data)
}
inline std::string* RawData::unsafe_arena_release_data() {
  // @@protoc_insertion_point(field_unsafe_arena_release:dashql.proto.web_api.RawData.data)
  GOOGLE_DCHECK(GetArenaNoVirtual() != nullptr);
...
inline void RawData::unsafe_arena_set_allocated_data(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:dashql.proto.web_api.RawData.data)
}
...
template <> struct is_proto_enum< ::dashql::proto::web_api::StatusCode> : ::std::true_type {};
