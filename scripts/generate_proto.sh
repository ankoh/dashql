...
SPEC_DIR="${PROJECT_ROOT}/libs/dashql-proto/spec/"
SPEC_INDEX="${SPEC_DIR}/proto.fbs"

OUT_DIR_CPP="${PROJECT_ROOT}/libs/dashql-proto/gen/cc/include/dashql"
OUT_DIR_TS="${PROJECT_ROOT}/libs/dashql-proto/gen/ts"
OUT_DIR_RS="${PROJECT_ROOT}/libs/dashql-proto/gen/rs"
