...
enum class ErrorCode { INTERNAL_ERROR, INVALID_REQUEST, QUERY_FAILED, TABLEGEN_INVALID_INPUT_INDEX, TABLEGEN_CIRCULAR_DEPENDENCY, NOT_IMPLEMENTED, CSV_PARSER_ERROR, CSV_EOF };
