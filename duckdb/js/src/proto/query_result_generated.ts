...
import * as NS9031375772826173481 from "./query_plan_generated";
import * as NS14234077259850089788 from "./vector_generated";
/**
 * @constructor
 */
 ...
 */
columns(index: number, obj?:NS14234077259850089788.duckdb_webapi.proto.Vector):NS14234077259850089788.duckdb_webapi.proto.Vector|null {
  var offset = this.bb!.__offset(this.bb_pos, 8);
  return offset ? (obj || new NS14234077259850089788.duckdb_webapi.proto.Vector()).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!) : null;
};
 ...
 */
queryPlan(obj?:NS9031375772826173481.duckdb_webapi.proto.QueryPlan):NS9031375772826173481.duckdb_webapi.proto.QueryPlan|null {
  var offset = this.bb!.__offset(this.bb_pos, 6);
  return offset ? (obj || new NS9031375772826173481.duckdb_webapi.proto.QueryPlan()).__init(this.bb!.__indirect(this.bb_pos + offset), this.bb!) : null;
};
 ...
 */
columnTypes(index: number, obj?:NS15870704214243989102.duckdb_webapi.proto.SQLType):NS15870704214243989102.duckdb_webapi.proto.SQLType|null {
  var offset = this.bb!.__offset(this.bb_pos, 8);
  return offset ? (obj || new NS15870704214243989102.duckdb_webapi.proto.SQLType()).__init(this.bb!.__vector(this.bb_pos + offset) + index * 6, this.bb!) : null;
};
