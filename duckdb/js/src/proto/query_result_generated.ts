...
import * as NS13494074937311534438 from "./query_plan_generated";
import * as NS15444589021119839355 from "./vector_generated";
/**
 * @constructor
 */
...
/**
 * @param number index
 * @param duckdb_webapi.proto.Vector= obj
 * @returns duckdb_webapi.proto.Vector
 */
columns(index: number, obj?:NS15444589021119839355.duckdb_webapi.proto.Vector):NS15444589021119839355.duckdb_webapi.proto.Vector|null {
  var offset = this.bb!.__offset(this.bb_pos, 8);
  return offset ? (obj || new NS15444589021119839355.duckdb_webapi.proto.Vector()).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!) : null;
};
...
/**
 * @param duckdb_webapi.proto.QueryPlan= obj
 * @returns duckdb_webapi.proto.QueryPlan|null
 */
queryPlan(obj?:NS13494074937311534438.duckdb_webapi.proto.QueryPlan):NS13494074937311534438.duckdb_webapi.proto.QueryPlan|null {
  var offset = this.bb!.__offset(this.bb_pos, 6);
  return offset ? (obj || new NS13494074937311534438.duckdb_webapi.proto.QueryPlan()).__init(this.bb!.__indirect(this.bb_pos + offset), this.bb!) : null;
};

/**
 * @param number index
 * @param duckdb_webapi.proto.SQLType= obj
 * @returns duckdb_webapi.proto.SQLType
 */
columnTypes(index: number, obj?:NS10039894467022227273.duckdb_webapi.proto.SQLType):NS10039894467022227273.duckdb_webapi.proto.SQLType|null {
  var offset = this.bb!.__offset(this.bb_pos, 8);
  return offset ? (obj || new NS10039894467022227273.duckdb_webapi.proto.SQLType()).__init(this.bb!.__vector(this.bb_pos + offset) + index * 6, this.bb!) : null;
};
...
/**
 * @param number index
 * @param duckdb_webapi.proto.QueryResultChunk= obj
 * @returns duckdb_webapi.proto.QueryResultChunk
 */
dataChunks(index: number, obj?:duckdb_webapi.proto.QueryResultChunk):duckdb_webapi.proto.QueryResultChunk|null {
  var offset = this.bb!.__offset(this.bb_pos, 12);
  return offset ? (obj || new duckdb_webapi.proto.QueryResultChunk()).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!) : null;
};
