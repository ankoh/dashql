      ...
      public:
        ...
        class Response {
          ...
          protected:
            ...
            /// The status code
            dashql::proto::web_api::StatusCode status_code;
            /// The error (if any)
            std::string error;
            /// The data (if any)
            ...
            /// Request failed
            void requestFailed(dashql::proto::web_api::StatusCode status, std::string error);
        ...
        struct GridArea {
            ...
            GridArea(uint16_t xBegin, uint16_t xEnd, uint16_t yBegin, uint16_t yEnd): xBegin(xBegin), xEnd(xEnd), yBegin(yBegin), yEnd(yEnd) {}
        } __attribute((packed));
