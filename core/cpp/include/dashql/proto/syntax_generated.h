...
enum class AttributeKey : uint16_t {
  ...
  SQL_NUMERIC_TYPE_MODIFIERS = 37,
  SQL_NUMERIC_TYPE_TAG = 38,
  SQL_ORDER_DIRECTION = 39,
  SQL_ORDER_NULLRULE = 40,
  SQL_ORDER_VALUE = 41,
  SQL_QUALIFIED_NAME_CATALOG = 42,
  SQL_QUALIFIED_NAME_RELATION = 43,
  SQL_QUALIFIED_NAME_SCHEMA = 44,
  SQL_RESULT_TARGET_INDIRECTION = 45,
  SQL_RESULT_TARGET_NAME = 46,
  SQL_RESULT_TARGET_VALUE = 47,
  SQL_SELECT_ALL = 48,
  SQL_SELECT_DISTINCT = 49,
  SQL_SELECT_FROM = 50,
  SQL_SELECT_GROUPS = 51,
  SQL_SELECT_HAVING = 52,
  SQL_SELECT_INTO = 53,
  SQL_SELECT_LIMIT = 54,
  SQL_SELECT_OFFSET = 55,
  SQL_SELECT_ORDER = 56,
  SQL_SELECT_TABLE = 57,
  ...
  SQL_SELECT_WITH_CTES = 62,
  SQL_SELECT_WITH_RECURSIVE = 63,
  SQL_TABLE_ALIAS = 64,
  SQL_TABLE_INHERIT = 65,
  SQL_TABLE_NAME = 66,
  SQL_TEMP_NAME = 67,
  SQL_TEMP_TYPE = 68,
  SQL_TYPENAME_ARRAY = 69,
  SQL_TYPENAME_SETOF = 70,
  SQL_TYPENAME_TYPE = 71,
  SQL_WINDOW_BOUND_DIRECTION = 72,
  SQL_WINDOW_BOUND_MODE = 73,
  SQL_WINDOW_BOUND_VALUE = 74,
  SQL_WINDOW_DEF_FRAME = 75,
  SQL_WINDOW_DEF_NAME = 76,
  SQL_WINDOW_FRAME_BOUNDS = 77,
  SQL_WINDOW_FRAME_EXCLUDE = 78,
  SQL_WINDOW_FRAME_MODE = 79,
  SQL_WINDOW_FRAME_NAME = 80,
  SQL_WINDOW_FRAME_PARTITION = 81,
  MIN = NONE,
  MAX = SQL_WINDOW_FRAME_PARTITION
};

inline const AttributeKey (&EnumValuesAttributeKey())[82] {
...
inline const flatbuffers::TypeTable *AttributeKeyTypeTable() {
  ...
  static const flatbuffers::TypeTable tt = {
    flatbuffers::ST_ENUM, 82, type_codes, type_refs, nullptr, nullptr, names
  };
  return &tt;
}
