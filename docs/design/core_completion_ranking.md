...
- A likely catalog name with `THROUGH_CATALOG` outranks an expected keyword with prefix match (`20+2 > 20`).
...
| Candidate       | Base | SUBSTRING | PREFIX | KEYWORD_MATCH | KEYWORD_A | IN_SCOPE | Total |
|-----------------|------|-----------|--------|---------------|-----------|----------|-------|
...
| Candidate       | Base | SUBSTRING | PREFIX | EXACT | KEYWORD_MATCH | KEYWORD_A | IN_SCOPE | Total |
|-----------------|------|-----------|--------|-------|---------------|-----------|----------|-------|
...
- Prefix-matching keyword (WHERE): EXPECTED_KEYWORD_MATCH(20) + SUBSTRING(30) + PREFIX(5) + KEYWORD_A(4) = 59 > 50 ✓
...
- Best keyword (KEYWORD_A + expected + substring + prefix): 4 + 20 + 30 + 5 = 59, tie broken lexicographically
