 ...
 */
typeId():SQLTypeID {
  return /** @type {SQLTypeID} */ (this.bb.readUint8(this.bb_pos));
};
...
operatorTypes(index: number):LogicalOperatorType|null {
  ...
  return offset ? /** @type {LogicalOperatorType} */ (this.bb.readUint8(this.bb.__vector(this.bb_pos + offset) + index)) : /** @type {LogicalOperatorType} */ (0);
};
...
typeId():RawTypeID {
  var offset = this.bb.__offset(this.bb_pos, 4);
  return offset ? /** @type {RawTypeID} */ (this.bb.readUint8(this.bb_pos + offset)) : RawTypeID.INVALID;
};
...
columnRawTypes(index: number):RawTypeID|null {
  var offset = this.bb.__offset(this.bb_pos, 8);
  return offset ? /** @type {RawTypeID} */ (this.bb.readUint8(this.bb.__vector(this.bb_pos + offset) + index)) : /** @type {RawTypeID} */ (0);
};
