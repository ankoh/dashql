 ...
 * @constructor
 */
export class FormattedQueryPlan {
  bb: flatbuffers.ByteBuffer|null = null;
 ...
 * @param number i
 * @param flatbuffers.ByteBuffer bb
 * @returns FormattedQueryPlan
 */
__init(i:number, bb:flatbuffers.ByteBuffer):FormattedQueryPlan {
  this.bb_pos = i;
  this.bb = bb;
  return this;
};
...
/**
 * @param flatbuffers.ByteBuffer bb
 * @param FormattedQueryPlan= obj
 * @returns FormattedQueryPlan
 */
static getRootAsFormattedQueryPlan(bb:flatbuffers.ByteBuffer, obj?:FormattedQueryPlan):FormattedQueryPlan {
  return (obj || new FormattedQueryPlan).__init(bb.readInt32(bb.position()) + bb.position(), bb);
};
 ...
 * @param flatbuffers.Builder builder
 */
static startFormattedQueryPlan(builder:flatbuffers.Builder) {
 ...
 * @returns flatbuffers.Offset
 */
static endFormattedQueryPlan(builder:flatbuffers.Builder):flatbuffers.Offset {
  var offset = builder.endObject();
  return offset;
};

static createFormattedQueryPlan(builder:flatbuffers.Builder, textOffset:flatbuffers.Offset):flatbuffers.Offset {
  FormattedQueryPlan.startFormattedQueryPlan(builder);
  FormattedQueryPlan.addText(builder, textOffset);
  return FormattedQueryPlan.endFormattedQueryPlan(builder);
}
}
/**
 * @constructor
