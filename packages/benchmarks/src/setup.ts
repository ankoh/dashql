...
const DUCKDB_BUNDLES = {
    mvp: {
        mainModule: path.resolve(MODULES_DIR, '@duckdb/duckdb-wasm/dist/duckdb.wasm'),
        mainWorker: path.resolve(MODULES_DIR, '@duckdb/duckdb-wasm/dist/duckdb-node.worker.cjs'),
    },
    eh: {
        mainModule: path.resolve(MODULES_DIR, '@duckdb/duckdb-wasm/dist/duckdb-eh.wasm'),
        mainWorker: path.resolve(MODULES_DIR, '@duckdb/duckdb-wasm/dist/duckdb-node-eh.worker.cjs'),
    },
};
