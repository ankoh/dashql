...
#define X(ENUM_TYPE, TYPE_TABLE)               \
    case buffers::parser::NodeType::ENUM_TYPE: \
        ...
        X(ENUM_VIS_SPEC_KEY, VisSpecKeyTypeTable)
        X(ENUM_VIS_ENCODING_CHANNEL, VisEncodingChannelTypeTable)
        X(ENUM_VIS_FIELD_DEF_KEY, VisFieldDefKeyTypeTable)
        X(ENUM_VIS_SCALE_KEY, VisScaleKeyTypeTable)
        X(ENUM_VIS_AXIS_KEY, VisAxisKeyTypeTable)
        X(ENUM_VIS_LEGEND_KEY, VisLegendKeyTypeTable)
        X(ENUM_VIS_MARK_TYPE, VisMarkTypeTypeTable)
        X(ENUM_VIS_FIELD_TYPE, VisFieldTypeTypeTable)
