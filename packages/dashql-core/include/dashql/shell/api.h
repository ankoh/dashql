...
DASHQL_SHELL_EXPORT uint32_t dashql_shell_prompt_set(DashQLShell* shell, const uint8_t* text, size_t text_length,
                                                     DashQLShellPromptResult* result);
DASHQL_SHELL_EXPORT uint32_t dashql_shell_prompt_insert(DashQLShell* shell, const uint8_t* text, size_t text_length,
                                                        DashQLShellPromptResult* result);
...
DASHQL_SHELL_EXPORT uint32_t dashql_shell_prompt_delete_backward(DashQLShell* shell, DashQLShellPromptResult* result);
DASHQL_SHELL_EXPORT uint32_t dashql_shell_prompt_delete_forward(DashQLShell* shell, DashQLShellPromptResult* result);
DASHQL_SHELL_EXPORT uint32_t dashql_shell_prompt_complete(DashQLShell* shell, size_t limit,
                                                          DashQLShellCompletionResult* result);
DASHQL_SHELL_EXPORT uint32_t dashql_shell_prompt_apply_completion(DashQLShell* shell,
                                                                  const DashQLShellCompletionCandidate* candidate,
                                                                  DashQLShellPromptResult* result);
DASHQL_SHELL_EXPORT uint32_t dashql_shell_prompt_consume(DashQLShell* shell, uint32_t key, const uint8_t* text,
                                                         size_t text_length, DashQLShellPromptResult* result);
...
DASHQL_SHELL_EXPORT uint32_t dashql_shell_terminal_open(DashQLShell* shell, const uint8_t* prompt, size_t prompt_length,
                                                        DashQLShellTerminalResult* result);
DASHQL_SHELL_EXPORT uint32_t dashql_shell_terminal_consume(DashQLShell* shell, uint32_t key, const uint8_t* text,
                                                           size_t text_length, DashQLShellTerminalResult* result);
DASHQL_SHELL_EXPORT uint32_t dashql_shell_terminal_finish_query(DashQLShell* shell, const uint8_t* output,
                                                                size_t output_length, bool error,
                                                                DashQLShellTerminalResult* result);
DASHQL_SHELL_EXPORT uint32_t dashql_shell_terminal_query_progress(DashQLShell* shell, const uint8_t* message,
                                                                  size_t message_length, bool advance_frame,
                                                                  DashQLShellTerminalResult* result);
DASHQL_SHELL_EXPORT uint32_t dashql_shell_terminal_query_progress_clear(DashQLShell* shell,
                                                                        DashQLShellTerminalResult* result);
DASHQL_SHELL_EXPORT uint32_t dashql_shell_terminal_status(DashQLShell* shell, const uint8_t* message,
                                                          size_t message_length, DashQLShellTerminalResult* result);
...
DASHQL_SHELL_EXPORT uint32_t dashql_shell_history_import(DashQLShell* shell, const uint8_t* data, size_t data_length,
                                                         DashQLShellResult* result);

DASHQL_SHELL_EXPORT uint32_t dashql_shell_start_query(DashQLShell* shell, const uint8_t* query, size_t query_length,
                                                      DashQLShellResult* result);

DASHQL_SHELL_EXPORT uint32_t dashql_shell_complete_effect(DashQLShell* shell, uint32_t effect_id_low,
                                                          uint32_t effect_id_high, uint32_t completion_status,
                                                          const uint8_t* data, size_t data_length,
                                                          DashQLShellResult* result);

DASHQL_SHELL_EXPORT uint32_t dashql_shell_cancel_effect(DashQLShell* shell, uint32_t effect_id_low,
                                                        uint32_t effect_id_high, DashQLShellResult* result);
