...
const workerPath = path.resolve(__dirname, '../../../node_modeuls/@dashql/duckdb/dist/duckdb-node-parallel.worker.js');
const wasmPath = path.resolve(__dirname, '../../../node_modeuls/@dashql/duckdb/dist/duckdb.wasm');
