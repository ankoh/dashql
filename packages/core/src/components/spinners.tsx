...
export const RectangleWaveSpinner: React.FC<IRectangleWaveSpinnerProps> = (props: IRectangleWaveSpinnerProps) => {
    ...
    return (
        <div className={clsx(props.className, styles.rw)}>
            <div
                className={clsx(styles.rw_rect_1, {
                    [styles.rw_rect_active]: props.active,
                })}
                style={s}
            />
            <div
                className={clsx(styles.rw_rect_2, {
                    [styles.rw_rect_active]: props.active,
                })}
                style={s}
            />
            <div
                className={clsx(styles.rw_rect_3, {
                    [styles.rw_rect_active]: props.active,
                })}
                style={s}
            />
            <div
                className={clsx(styles.rw_rect_4, {
                    [styles.rw_rect_active]: props.active,
                })}
                style={s}
            />
            <div
                className={clsx(styles.rw_rect_5, {
                    [styles.rw_rect_active]: props.active,
                })}
                style={s}
            />
