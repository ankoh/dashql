...
export function useStickyRowAndColumnHeaders<Data>(Cell: React.ElementType, cellLocation: GridCellLocation, className: string, headerRowCount: number, dataRef: React.RefObject<Data | null>) {
