// Vendored from fast-kde@0.2.2 (src/deriche.js).
// Copyright (c) 2021, UW Interactive Data Lab. Licensed under the BSD 3-Clause License.
// See the third-party NOTICE for the full license text.
//
