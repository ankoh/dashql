...
export type TypesElement<T extends TagType> = TypesElementProps<T> & (T extends React.ElementType ? React.ComponentPropsWithoutRef<T> : Record<string, unknown>);
...
const Context = React.createContext<InitialTypesState<TagType>>(initialState);
...
const DispatchTypes = React.createContext<Dispatch<TagType>>(() => { });
