...
export type SectionElement<T extends TagType = 'span'> = SectionElementProps<T> & React.ComponentPropsWithoutRef<T>;
...
const Context = React.createContext<InitialState<TagType>>(initialState);
...
const DispatchSection = React.createContext<Dispatch>(() => { });
...
export const Section: React.FC<React.PropsWithChildren<SectionProps>> = ({ initial, dispatch, children }) => {
    return (
