 ...
 * @returns flatbuffers.Offset
 */
static createValue(builder:flatbuffers.Builder, location_offset: number, location_length: number, type: dashql.proto.syntax.ValueType, value: flatbuffers.Long):flatbuffers.Offset {
  builder.prep(8, 24);
