...
import * as NS11228939722480868292 from "./query_plan_generated";
import * as NS8707945838817583293 from "./vector_generated";
/**
 * @constructor
 */
 ...
 * @returns Vector
 */
columns(index: number, obj?:NS8707945838817583293.Vector):NS8707945838817583293.Vector|null {
  var offset = this.bb!.__offset(this.bb_pos, 8);
  return offset ? (obj || new NS8707945838817583293.Vector()).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!) : null;
};
 ...
 */
queryPlan(obj?:NS11228939722480868292.QueryPlan):NS11228939722480868292.QueryPlan|null {
  var offset = this.bb!.__offset(this.bb_pos, 6);
  return offset ? (obj || new NS11228939722480868292.QueryPlan()).__init(this.bb!.__indirect(this.bb_pos + offset), this.bb!) : null;
};
 ...
 * @returns SQLType
 */
columnTypes(index: number, obj?:NS5079300908784063803.SQLType):NS5079300908784063803.SQLType|null {
  var offset = this.bb!.__offset(this.bb_pos, 8);
  return offset ? (obj || new NS5079300908784063803.SQLType()).__init(this.bb!.__vector(this.bb_pos + offset) + index * 6, this.bb!) : null;
};
