...
import * as NS934963866304085422 from "./query_plan_generated";
 ...
 */
physicalType():NS16426348653616406419.PhysicalTypeID {
  var offset = this.bb!.__offset(this.bb_pos, 4);
  return offset ? /**  */ (this.bb!.readUint8(this.bb_pos + offset)) : NS16426348653616406419.PhysicalTypeID.NA;
};
 ...
 */
static addPhysicalType(builder:flatbuffers.Builder, physicalType:NS16426348653616406419.PhysicalTypeID) {
  builder.addFieldInt8(0, physicalType, NS16426348653616406419.PhysicalTypeID.NA);
};
...
static createQueryResultColumn(builder:flatbuffers.Builder, physicalType:NS16426348653616406419.PhysicalTypeID, nullMaskOffset:flatbuffers.Offset, rowsU8Offset:flatbuffers.Offset, rowsI16Offset:flatbuffers.Offset, rowsU16Offset:flatbuffers.Offset, rowsI32Offset:flatbuffers.Offset, rowsI64Offset:flatbuffers.Offset, rowsU64Offset:flatbuffers.Offset, rowsF32Offset:flatbuffers.Offset, rowsF64Offset:flatbuffers.Offset, rowsStringOffset:flatbuffers.Offset):flatbuffers.Offset {
 ...
 */
queryPlan(obj?:NS934963866304085422.QueryPlan):NS934963866304085422.QueryPlan|null {
  var offset = this.bb!.__offset(this.bb_pos, 6);
  return offset ? (obj || new NS934963866304085422.QueryPlan()).__init(this.bb!.__indirect(this.bb_pos + offset), this.bb!) : null;
};
 ...
 * @returns LogicalType
 */
columnTypes(index: number, obj?:NS16426348653616406419.LogicalType):NS16426348653616406419.LogicalType|null {
  var offset = this.bb!.__offset(this.bb_pos, 8);
  return offset ? (obj || new NS16426348653616406419.LogicalType()).__init(this.bb!.__vector(this.bb_pos + offset) + index * 6, this.bb!) : null;
};
