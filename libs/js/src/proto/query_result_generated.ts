...
import * as NS2324455932539921278 from "./query_plan_generated";
 ...
 */
physicalType():NS14833747223363959619.PhysicalTypeID {
  var offset = this.bb!.__offset(this.bb_pos, 4);
  return offset ? /**  */ (this.bb!.readUint8(this.bb_pos + offset)) : NS14833747223363959619.PhysicalTypeID.NA;
};
 ...
 */
static addPhysicalType(builder:flatbuffers.Builder, physicalType:NS14833747223363959619.PhysicalTypeID) {
  builder.addFieldInt8(0, physicalType, NS14833747223363959619.PhysicalTypeID.NA);
};
...
static createQueryResultColumn(builder:flatbuffers.Builder, physicalType:NS14833747223363959619.PhysicalTypeID, nullMaskOffset:flatbuffers.Offset, rowsU8Offset:flatbuffers.Offset, rowsI16Offset:flatbuffers.Offset, rowsU16Offset:flatbuffers.Offset, rowsI32Offset:flatbuffers.Offset, rowsI64Offset:flatbuffers.Offset, rowsU64Offset:flatbuffers.Offset, rowsF32Offset:flatbuffers.Offset, rowsF64Offset:flatbuffers.Offset, rowsStringOffset:flatbuffers.Offset):flatbuffers.Offset {
 ...
 */
queryPlan(obj?:NS2324455932539921278.QueryPlan):NS2324455932539921278.QueryPlan|null {
  var offset = this.bb!.__offset(this.bb_pos, 6);
  return offset ? (obj || new NS2324455932539921278.QueryPlan()).__init(this.bb!.__indirect(this.bb_pos + offset), this.bb!) : null;
};
 ...
 * @returns LogicalType
 */
columnTypes(index: number, obj?:NS14833747223363959619.LogicalType):NS14833747223363959619.LogicalType|null {
  var offset = this.bb!.__offset(this.bb_pos, 8);
  return offset ? (obj || new NS14833747223363959619.LogicalType()).__init(this.bb!.__vector(this.bb_pos + offset) + index * 6, this.bb!) : null;
};
