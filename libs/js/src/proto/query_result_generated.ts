...
import * as NS12545093483751492437 from "./query_plan_generated";
import * as NS5034574600537336032 from "./vector_generated";
/**
 * @constructor
 */
 ...
 * @returns Vector
 */
columns(index: number, obj?:NS5034574600537336032.Vector):NS5034574600537336032.Vector|null {
  var offset = this.bb!.__offset(this.bb_pos, 8);
  return offset ? (obj || new NS5034574600537336032.Vector()).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!) : null;
};
 ...
 */
queryPlan(obj?:NS12545093483751492437.QueryPlan):NS12545093483751492437.QueryPlan|null {
  var offset = this.bb!.__offset(this.bb_pos, 6);
  return offset ? (obj || new NS12545093483751492437.QueryPlan()).__init(this.bb!.__indirect(this.bb_pos + offset), this.bb!) : null;
};
 ...
 * @returns SQLType
 */
columnTypes(index: number, obj?:NS13626615235527770290.SQLType):NS13626615235527770290.SQLType|null {
  var offset = this.bb!.__offset(this.bb_pos, 8);
  return offset ? (obj || new NS13626615235527770290.SQLType()).__init(this.bb!.__vector(this.bb_pos + offset) + index * 6, this.bb!) : null;
};
