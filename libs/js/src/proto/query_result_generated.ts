...
import * as NS7925483093487638204 from "./query_plan_generated";
 ...
 */
physicalType():NS15958428805001682893.PhysicalTypeID {
  var offset = this.bb!.__offset(this.bb_pos, 4);
  return offset ? /**  */ (this.bb!.readUint8(this.bb_pos + offset)) : NS15958428805001682893.PhysicalTypeID.NA;
};
 ...
 */
static addPhysicalType(builder:flatbuffers.Builder, physicalType:NS15958428805001682893.PhysicalTypeID) {
  builder.addFieldInt8(0, physicalType, NS15958428805001682893.PhysicalTypeID.NA);
};
 ...
 */
queryPlan(obj?:NS7925483093487638204.QueryPlan):NS7925483093487638204.QueryPlan|null {
  var offset = this.bb!.__offset(this.bb_pos, 6);
  return offset ? (obj || new NS7925483093487638204.QueryPlan()).__init(this.bb!.__indirect(this.bb_pos + offset), this.bb!) : null;
};
 ...
 * @returns LogicalType
 */
columnTypes(index: number, obj?:NS15958428805001682893.LogicalType):NS15958428805001682893.LogicalType|null {
  var offset = this.bb!.__offset(this.bb_pos, 8);
  return offset ? (obj || new NS15958428805001682893.LogicalType()).__init(this.bb!.__vector(this.bb_pos + offset) + index * 6, this.bb!) : null;
};
