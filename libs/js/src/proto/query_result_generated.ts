...
import * as NS14354052324062381123 from "./query_plan_generated";
import * as NS13439593573212261714 from "./vector_generated";
/**
 * @constructor
 */
 ...
 * @returns Vector
 */
columns(index: number, obj?:NS13439593573212261714.Vector):NS13439593573212261714.Vector|null {
  var offset = this.bb!.__offset(this.bb_pos, 8);
  return offset ? (obj || new NS13439593573212261714.Vector()).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!) : null;
};
 ...
 */
queryPlan(obj?:NS14354052324062381123.QueryPlan):NS14354052324062381123.QueryPlan|null {
  var offset = this.bb!.__offset(this.bb_pos, 6);
  return offset ? (obj || new NS14354052324062381123.QueryPlan()).__init(this.bb!.__indirect(this.bb_pos + offset), this.bb!) : null;
};
 ...
 * @returns SQLType
 */
columnTypes(index: number, obj?:NS3407583852048818852.SQLType):NS3407583852048818852.SQLType|null {
  var offset = this.bb!.__offset(this.bb_pos, 8);
  return offset ? (obj || new NS3407583852048818852.SQLType()).__init(this.bb!.__vector(this.bb_pos + offset) + index * 6, this.bb!) : null;
};
