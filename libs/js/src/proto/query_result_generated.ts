...
import * as NS14798111611754956428 from "./query_plan_generated";
import * as NS15244676428800754453 from "./vector_generated";
/**
 * @constructor
 */
 ...
 * @returns Vector
 */
columns(index: number, obj?:NS15244676428800754453.Vector):NS15244676428800754453.Vector|null {
  var offset = this.bb!.__offset(this.bb_pos, 8);
  return offset ? (obj || new NS15244676428800754453.Vector()).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!) : null;
};
 ...
 */
queryPlan(obj?:NS14798111611754956428.QueryPlan):NS14798111611754956428.QueryPlan|null {
  var offset = this.bb!.__offset(this.bb_pos, 6);
  return offset ? (obj || new NS14798111611754956428.QueryPlan()).__init(this.bb!.__indirect(this.bb_pos + offset), this.bb!) : null;
};
 ...
 * @returns SQLType
 */
columnTypes(index: number, obj?:NS7879164259699738547.SQLType):NS7879164259699738547.SQLType|null {
  var offset = this.bb!.__offset(this.bb_pos, 8);
  return offset ? (obj || new NS7879164259699738547.SQLType()).__init(this.bb!.__vector(this.bb_pos + offset) + index * 6, this.bb!) : null;
};
