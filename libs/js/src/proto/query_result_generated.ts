...
import * as NS9514016180471179228 from "./query_plan_generated";
import * as NS15846253345810624261 from "./vector_generated";
/**
 * @constructor
 */
 ...
 * @returns Vector
 */
columns(index: number, obj?:NS15846253345810624261.Vector):NS15846253345810624261.Vector|null {
  var offset = this.bb!.__offset(this.bb_pos, 8);
  return offset ? (obj || new NS15846253345810624261.Vector()).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!) : null;
};
 ...
 */
queryPlan(obj?:NS9514016180471179228.QueryPlan):NS9514016180471179228.QueryPlan|null {
  var offset = this.bb!.__offset(this.bb_pos, 6);
  return offset ? (obj || new NS9514016180471179228.QueryPlan()).__init(this.bb!.__indirect(this.bb_pos + offset), this.bb!) : null;
};
 ...
 * @returns SQLType
 */
columnTypes(index: number, obj?:NS10036243700668342019.SQLType):NS10036243700668342019.SQLType|null {
  var offset = this.bb!.__offset(this.bb_pos, 8);
  return offset ? (obj || new NS10036243700668342019.SQLType()).__init(this.bb!.__vector(this.bb_pos + offset) + index * 6, this.bb!) : null;
};
