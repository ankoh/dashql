...
import * as NS3688621769649552718 from "./query_plan_generated";
import * as NS16778392605487218771 from "./vector_generated";
/**
 * @constructor
 */
 ...
 */
columns(index: number, obj?:NS16778392605487218771.duckdb_webapi.proto.Vector):NS16778392605487218771.duckdb_webapi.proto.Vector|null {
  var offset = this.bb!.__offset(this.bb_pos, 8);
  return offset ? (obj || new NS16778392605487218771.duckdb_webapi.proto.Vector()).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!) : null;
};
 ...
 */
queryPlan(obj?:NS3688621769649552718.duckdb_webapi.proto.QueryPlan):NS3688621769649552718.duckdb_webapi.proto.QueryPlan|null {
  var offset = this.bb!.__offset(this.bb_pos, 6);
  return offset ? (obj || new NS3688621769649552718.duckdb_webapi.proto.QueryPlan()).__init(this.bb!.__indirect(this.bb_pos + offset), this.bb!) : null;
};
 ...
 */
columnTypes(index: number, obj?:NS9700128142407684257.duckdb_webapi.proto.SQLType):NS9700128142407684257.duckdb_webapi.proto.SQLType|null {
  var offset = this.bb!.__offset(this.bb_pos, 8);
  return offset ? (obj || new NS9700128142407684257.duckdb_webapi.proto.SQLType()).__init(this.bb!.__vector(this.bb_pos + offset) + index * 6, this.bb!) : null;
};
