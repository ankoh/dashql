...
import * as NS1369368919576173492 from "./query_plan_generated";
 ...
 */
physicalType():NS2627846559874099141.PhysicalTypeID {
  var offset = this.bb!.__offset(this.bb_pos, 4);
  return offset ? /**  */ (this.bb!.readUint8(this.bb_pos + offset)) : NS2627846559874099141.PhysicalTypeID.NA;
};
 ...
 * @returns I128
 */
rowsI128(index: number, obj?:I128):I128|null {
 ...
 */
static addPhysicalType(builder:flatbuffers.Builder, physicalType:NS2627846559874099141.PhysicalTypeID) {
  builder.addFieldInt8(0, physicalType, NS2627846559874099141.PhysicalTypeID.NA);
};
...
/**
 * @param flatbuffers.Builder builder
 * @param flatbuffers.Offset rowsI128Offset
 */
static addRowsI128(builder:flatbuffers.Builder, rowsI128Offset:flatbuffers.Offset) {
  builder.addFieldOffset(8, rowsI128Offset, 0);
};
 ...
 * @param number numElems
 */
static startRowsI128Vector(builder:flatbuffers.Builder, numElems:number) {
...
static addRowsF32(builder:flatbuffers.Builder, rowsF32Offset:flatbuffers.Offset) {
  builder.addFieldOffset(9, rowsF32Offset, 0);
};
...
static addRowsF64(builder:flatbuffers.Builder, rowsF64Offset:flatbuffers.Offset) {
  builder.addFieldOffset(10, rowsF64Offset, 0);
};
...
static addRowsString(builder:flatbuffers.Builder, rowsStringOffset:flatbuffers.Offset) {
  builder.addFieldOffset(11, rowsStringOffset, 0);
};
...
static createQueryResultColumn(builder:flatbuffers.Builder, physicalType:NS2627846559874099141.PhysicalTypeID, nullMaskOffset:flatbuffers.Offset, rowsU8Offset:flatbuffers.Offset, rowsI16Offset:flatbuffers.Offset, rowsU16Offset:flatbuffers.Offset, rowsI32Offset:flatbuffers.Offset, rowsI64Offset:flatbuffers.Offset, rowsU64Offset:flatbuffers.Offset, rowsI128Offset:flatbuffers.Offset, rowsF32Offset:flatbuffers.Offset, rowsF64Offset:flatbuffers.Offset, rowsStringOffset:flatbuffers.Offset):flatbuffers.Offset {
  ...
  QueryResultColumn.addRowsI128(builder, rowsI128Offset);
 ...
 */
queryPlan(obj?:NS1369368919576173492.QueryPlan):NS1369368919576173492.QueryPlan|null {
  var offset = this.bb!.__offset(this.bb_pos, 6);
  return offset ? (obj || new NS1369368919576173492.QueryPlan()).__init(this.bb!.__indirect(this.bb_pos + offset), this.bb!) : null;
};
 ...
 * @returns LogicalType
 */
columnTypes(index: number, obj?:NS2627846559874099141.LogicalType):NS2627846559874099141.LogicalType|null {
  var offset = this.bb!.__offset(this.bb_pos, 8);
  return offset ? (obj || new NS2627846559874099141.LogicalType()).__init(this.bb!.__vector(this.bb_pos + offset) + index * 6, this.bb!) : null;
};
