...
dashql_csv_attribute:
    ENCODING '=' dashql_string_value             { $$ = sx::Attribute(@$, sx::AttributeKey::DASHQL_CSV_EXTRACT_ENCODING, $3); }
  | HEADER '=' dashql_csv_header_value           { $$ = sx::Attribute(@$, sx::AttributeKey::DASHQL_CSV_EXTRACT_HEADER, $3); }
  | DELIMITER '=' dashql_string_value            { $$ = sx::Attribute(@$, sx::AttributeKey::DASHQL_CSV_EXTRACT_DELIMITER, $3); }
  | QUOTE '=' dashql_string_value                { $$ = sx::Attribute(@$, sx::AttributeKey::DASHQL_CSV_EXTRACT_QUOTE, $3); }
  | DATE FORMAT '=' dashql_string_value          { $$ = sx::Attribute(@$, sx::AttributeKey::DASHQL_CSV_EXTRACT_DATE_FORMAT, $4); }
  | TIMESTAMP FORMAT '=' dashql_string_value     { $$ = sx::Attribute(@$, sx::AttributeKey::DASHQL_CSV_EXTRACT_TIMESTAMP_FORMAT, $4); }
    ;
