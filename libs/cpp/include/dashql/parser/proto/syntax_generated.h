...
enum class AttributeKey : uint16_t {
  ...
  SQL_EXPRESSION_FUNCTION = 36,
  SQL_EXPRESSION_ARG = 37,
  SQL_EXPRESSION_ARG_LEFT = 38,
  SQL_EXPRESSION_ARG_RIGHT = 39,
  SQL_EXPRESSION_ARGS = 40,
  SQL_INDIRECTION_INDEX = 41,
  SQL_INDIRECTION_LOWER_BOUND = 42,
  SQL_INDIRECTION_UPPER_BOUND = 43,
  SQL_NUMERIC_TYPE_MODIFIERS = 44,
  SQL_NUMERIC_TYPE_TAG = 45,
  SQL_ORDER_DIRECTION = 46,
  SQL_ORDER_NULLRULE = 47,
  SQL_ORDER_VALUE = 48,
  SQL_QUALIFIED_NAME_CATALOG = 49,
  SQL_QUALIFIED_NAME_RELATION = 50,
  SQL_QUALIFIED_NAME_SCHEMA = 51,
  SQL_RESULT_TARGET_INDIRECTION = 52,
  SQL_RESULT_TARGET_NAME = 53,
  SQL_RESULT_TARGET_VALUE = 54,
  SQL_SELECT_ALL = 55,
  SQL_SELECT_DISTINCT = 56,
  SQL_SELECT_FROM = 57,
  SQL_SELECT_GROUPS = 58,
  SQL_SELECT_HAVING = 59,
  SQL_SELECT_INTO = 60,
  SQL_SELECT_LIMIT = 61,
  SQL_SELECT_OFFSET = 62,
  SQL_SELECT_ORDER = 63,
  SQL_SELECT_TABLE = 64,
  SQL_SELECT_TARGETS = 65,
  SQL_SELECT_VALUES = 66,
  SQL_SELECT_WHERE = 67,
  SQL_SELECT_WINDOWS = 68,
  SQL_SELECT_WITH_CTES = 69,
  SQL_SELECT_WITH_RECURSIVE = 70,
  SQL_TABLE_ALIAS = 71,
  SQL_TABLE_INHERIT = 72,
  SQL_TABLE_NAME = 73,
  SQL_TEMP_NAME = 74,
  SQL_TEMP_TYPE = 75,
  SQL_WINDOW_BOUND_DIRECTION = 76,
  SQL_WINDOW_BOUND_MODE = 77,
  SQL_WINDOW_BOUND_VALUE = 78,
  SQL_WINDOW_DEF_FRAME = 79,
  SQL_WINDOW_DEF_NAME = 80,
  SQL_WINDOW_FRAME_BOUNDS = 81,
  SQL_WINDOW_FRAME_EXCLUDE = 82,
  SQL_WINDOW_FRAME_MODE = 83,
  SQL_WINDOW_FRAME_NAME = 84,
  SQL_WINDOW_FRAME_PARTITION = 85,
  MIN = NONE,
  MAX = SQL_WINDOW_FRAME_PARTITION
};

inline const AttributeKey (&EnumValuesAttributeKey())[86] {
  static const AttributeKey values[] = {
    ...
    AttributeKey::SQL_EXPRESSION_ARG,
    AttributeKey::SQL_EXPRESSION_ARG_LEFT,
    AttributeKey::SQL_EXPRESSION_ARG_RIGHT,
...
inline const char * const *EnumNamesAttributeKey() {
  static const char * const names[87] = {
    ...
    "SQL_EXPRESSION_ARG",
    "SQL_EXPRESSION_ARG_LEFT",
    "SQL_EXPRESSION_ARG_RIGHT",
    "SQL_EXPRESSION_ARGS",
...
inline const flatbuffers::TypeTable *AttributeKeyTypeTable() {
  ...
  static const flatbuffers::TypeTable tt = {
    flatbuffers::ST_ENUM, 86, type_codes, type_refs, nullptr, nullptr, names
  };
  return &tt;
}
