...
enum class NodeType : uint16_t {
  ...
  SQL_INDIRECTION = 14,
  SQL_INTO = 15,
  SQL_QUALIFIED_NAME = 16,
  SQL_RELATION_EXPR = 17,
  SQL_RESULT_TARGET = 18,
  SQL_SELECT = 19,
  SQL_TABLE_REF = 20,
  SQL_WINDOW_BOUND = 21,
  SQL_WINDOW_DEF = 22,
...
enum class AttributeKey : uint16_t {
  ...
  SQL_COMBINE_INPUT = 35,
  SQL_COMBINE_OPERATION = 36,
  SQL_INDIRECTION_INDEX = 37,
  SQL_INDIRECTION_LOWER_BOUND = 38,
  SQL_INDIRECTION_UPPER_BOUND = 39,
  SQL_QUALIFIED_NAME_CATALOG = 40,
  SQL_QUALIFIED_NAME_RELATION = 41,
  SQL_QUALIFIED_NAME_SCHEMA = 42,
  SQL_RESULT_TARGET_INDIRECTION = 43,
  SQL_RESULT_TARGET_NAME = 44,
  SQL_RESULT_TARGET_VALUE = 45,
  SQL_SELECT_ALL = 46,
  SQL_SELECT_DISTINCT = 47,
  SQL_SELECT_FROM = 48,
  SQL_SELECT_GROUPS = 49,
  SQL_SELECT_HAVING = 50,
  SQL_SELECT_INTO = 51,
  SQL_SELECT_LIMIT_COUNT = 52,
  SQL_SELECT_LIMIT_OFFSET = 53,
  SQL_SELECT_SORT = 54,
  SQL_SELECT_TARGETS = 55,
  SQL_SELECT_VALUES = 56,
  SQL_SELECT_WHERE = 57,
  SQL_SELECT_WINDOWS = 58,
  SQL_SELECT_WITH = 59,
  SQL_TABLE_ALIAS = 60,
  SQL_TABLE_INHERIT = 61,
  SQL_TABLE_NAME = 62,
  SQL_TEMP_NAME = 63,
  SQL_TEMP_TYPE = 64,
  SQL_WINDOW_BOUND_DIRECTION = 65,
  SQL_WINDOW_BOUND_MODE = 66,
  SQL_WINDOW_BOUND_VALUE = 67,
  SQL_WINDOW_DEF_FRAME = 68,
  SQL_WINDOW_DEF_NAME = 69,
  SQL_WINDOW_FRAME_BOUNDS = 70,
  SQL_WINDOW_FRAME_EXCLUDE = 71,
  SQL_WINDOW_FRAME_MODE = 72,
  SQL_WINDOW_FRAME_NAME = 73,
  SQL_WINDOW_FRAME_PARTITION = 74,
  MIN = NONE,
  MAX = SQL_WINDOW_FRAME_PARTITION
};

inline const AttributeKey (&EnumValuesAttributeKey())[75] {
...
inline const flatbuffers::TypeTable *AttributeKeyTypeTable() {
  ...
  static const flatbuffers::TypeTable tt = {
    flatbuffers::ST_ENUM, 75, type_codes, type_refs, nullptr, nullptr, names
  };
  return &tt;
}
