...
pub enum SystemError {
    ...
    Generic(String),
    TargetNotAvailable(Option<usize>, String),
    TargetNotKnown(Option<usize>, String),
...
impl SystemError {
    pub fn const_description(&self) -> &'static str {
        match &self {
            ...
            SystemError::TargetNotAvailable(_, _) => "target not available",
            SystemError::TargetNotKnown(_, _) => "target not known",
...
impl<'a> fmt::Display for SystemError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match &self {
            ...
            SystemError::TargetNotAvailable(_node, name) => write!(f, "target not available: {}", name),
            SystemError::TargetNotKnown(_node, name) => write!(f, "target not known: {}", name),
